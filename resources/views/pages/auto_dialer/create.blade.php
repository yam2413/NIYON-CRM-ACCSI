								...
								<div class="card card-custom">
									<div class="card-header">
										<div class="card-title">
											<h3 class="card-label">Add One Campaign</h3>
										</div>
									</div>
									<div class="card-body">
												...
												<div class="card-body">
													...
													<div class="form-group row">
														...
														<div class="col-lg-6 col-md-9 col-sm-12">
															<input type="text" class="form-control" name="campaign_name" placeholder="" value="" />
													...
													{{-- <div class="form-group row">
														...
														<div class="col-lg-6 col-md-6 col-sm-12">
															<input data-switch="true" id="one_day_before"  type="checkbox" data-on-text="Enabled" data-handle-width="70" data-off-text="Disabled" data-on-color="primary" />
													...
													<div class="form-group row">
														...
														<div class="col-lg-6 col-md-6 col-sm-12">
															<input data-switch="true" id="prioritize_new_leads"  type="checkbox" data-on-text="Enabled" data-handle-width="70" data-off-text="Disabled" data-on-color="primary" />
															...
															<span class="form-text text-muted">By default will be randomized account status.</span>
														</div>
													</div> --}}
													...
													<div class="form-group row">
														...
														<div class="col-lg-6 col-md-6 col-sm-12">
															<input data-switch="true" id="auto_assign" checked="checked"  type="checkbox" data-on-text="Enabled" data-handle-width="70" data-off-text="Disabled" data-on-color="primary" />
													...
													<div class="form-group row">
														...
														<div class="col-lg-6 col-md-6 col-sm-12">
															<select name="filter_cycle_day" class="form-control">
																<option value="1">High to Low Value</option>
																<option value="2">Low to High Value</option>
															</select>
															<span class="form-text text-muted"></span>
														</div>
													</div>
													...
													<div class="form-group row">
															...
															<div class="col-lg-3 col-md-3 col-sm-12">
																<input type="text" class="form-control" id="start_time" name="start_time" placeholder="" value="" />
																<span class="form-text text-muted"></span>
															</div>
														
															<label class="col-form-label text-right col-lg-1 col-sm-12">End Time *</label>
															<div class="col-lg-3 col-md-9 col-sm-12">
																<input type="text" class="form-control" id="end_time" name="end_time" placeholder="" value="" />
																<span class="form-text text-muted"></span>
															</div>
												...
												<div class="card-footer">
													<div class="row">
														<div class="col-lg-9 ml-lg-auto">
															<button type="submit" class="btn btn-primary font-weight-bold mr-2" id="save-campaign"><i class="fa fa-save"></i> Submit</button>
															<button type="reset" class="btn btn-light-primary font-weight-bold" id="clear-campaign"><i class="flaticon-cancel"></i> Cancel
															</button>
															<a href="{{ route('pages.auto_dialer.index') }}" class="btn btn-light-primary font-weight-bold" data-dismiss="modal"><i class="flaticon2-back"></i> Back</a>
														</div>
													</div>
												</div>
											</form>
		                     ...
		                     if(data.error == 'false'){
		                        ...
		                        Swal.fire({
										...
										if (result.value) {
											...
											var get_campaign = '{{ route('pages.auto_dialer.dialer', ['file_id' => ':file_id']) }}';
											get_campaign = get_campaign.replace(':file_id', data.file_id);
