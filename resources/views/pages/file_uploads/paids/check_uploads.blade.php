									                  ...
									                  <div class="form-group row">
									                      ...
									                      <div class="col-lg-6">
									                        <label>Paid Amount <span style="color:red;">*</span></label>
									                         <select name="paid_amount" class="form-control select2">
									                         	<option value="">Select</option>
									                   ...
									                   <div class="form-group row">
									                      ...
									                      <div class="col-lg-6">
									                        <label>Paid Date <span style="color:red;">*</span></label>
									                         <select name="paid_date" class="form-control select2">
									                         	<option value="">Select</option>
									                         	@foreach ($select_datas as $key => $select_data)
									                         		<option value="{{$key}}">{{$select_data}}</option>
									                         	@endforeach
...
KTUtil.ready(function() {
	...
	jQuery(document).on('change', 'select[name="paid_date"],select[name="paid_amount"],select[name="account_no"]', function(e){
		var val = $(this).val();
     ...
     const validation =  FormValidation.formValidation(
        ...
        plugins: { //Learn more: https://formvalidation.io/guide/plugins
            ...
            validation.validate().then(function(status) {
	            ...
	            $.ajax({
			        url: "/upload_paids/data_type_upload_file",
			        type: "POST",
        ...
        plugins: { //Learn more: https://formvalidation.io/guide/plugins
            ...
            validation.validate().then(function(status) {
                ...
                if (status == 'Valid') {
                    ...
                    setTimeout(function(){
			             window.location = "/upload_paids/check_uploads/{{$uniq_id}}/view_uploaded/?"+data;
