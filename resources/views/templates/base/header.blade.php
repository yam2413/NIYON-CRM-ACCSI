							...
							<div class="container">
								...
								<div class="d-none d-lg-flex align-items-center mr-3">
									...
									<ul class="header-tabs nav align-self-end font-size-lg" role="tablist">
										...
										<!--begin::Item-->
										<li class="nav-item">
											<a href="#" class="nav-link py-4 px-6 {{ Request::is('dashboard') || Request::is('/') || Request::is('call_monitoring') || Request::is('call_monitoring/*') ? 'active' : '' }}" data-toggle="tab" data-target="#kt_header_tab_1" role="tab">Home</a>
										</li>
										<!--end::Item-->

										<!--begin::Item-->
										<li class="nav-item mr-3">
											<a href="#" class="nav-link py-4 px-6 {{ Request::is('leads') || Request::is('leads/*') || Request::is('reassign') || Request::is('reassign/*') || Request::is('auto_dialer') || Request::is('auto_dialer/*') || Request::is('pullout') || Request::is('pullout/*') || Request::is('leads_status') || Request::is('leads_status/*') ? 'active' : '' }}" data-toggle="tab" data-target="#kt_header_tab_2" role="tab">Leads</a>
										</li>
										<!--end::Item-->
										...
										<!--begin::Item-->
										<li class="nav-item mr-3">
											<a href="#" class="nav-link py-4 px-6 {{ Request::is('sms_template') || Request::is('sms_template/*') || Request::is('users') || Request::is('groups') || Request::is('emails') || Request::is('users/*') || Request::is('groups/*') || Request::is('emails/*') || Request::is('statuses/*') || Request::is('statuses/*') ? 'active' : '' }}" data-toggle="tab" data-target="#kt_header_tab_3" role="tab">Manage</a>
										</li>
										<!--end::Item-->

										<!--begin::Item-->
										<li class="nav-item mr-3">
											<a href="#" class="nav-link py-4 px-6 {{ Request::is('email_logs') || Request::is('email_logs/*') || Request::is('sms_logs') || Request::is('sms_logs/*') || Request::is('leads_logs') || Request::is('leads_logs/*') || Request::is('system_logs') || Request::is('system_logs/*') || Request::is('call_status') || Request::is('call_status/*') || Request::is('call_logs') || Request::is('call_logs/*') || Request::is('summary_calls') || Request::is('summary_calls/*') || Request::is('report_logs') || Request::is('report_logs/*') ? 'active' : '' }}" data-toggle="tab" data-target="#kt_header_tab_4" role="tab">Reports</a>
										</li>
										<!--end::Item-->
							...
							<div class="container">
								...
								<div class="header-navs header-navs-left" id="kt_header_navs">
									...
									<div class="tab-content">
										...
										<!--begin::Tab Pane-->
										<div class="tab-pane py-5 p-lg-0 {{ Request::is('dashboard') || Request::is('/') || Request::is('call_monitoring') || Request::is('call_monitoring/*') ? 'show active' : '' }}" id="kt_header_tab_1">
											...
											<div id="kt_header_menu" class="header-menu header-menu-mobile header-menu-layout-default">
												...
												<ul class="menu-nav">
													...
													<li class="menu-item menu-item-{{ Request::is('call_monitoring') || Request::is('call_monitoring/*') ? 'active' : '' }}" aria-haspopup="true">
														<a href="{{ route('pages.dashboard.call_monitoring') }}" class="menu-link">
															<span class="menu-text">Call Monitoring</span>
														</a>
													</li>
										...
										<!--begin::Tab Pane-->
										<div class="tab-pane py-5 p-lg-0 {{ Request::is('leads') || Request::is('leads/*') || Request::is('reassign') || Request::is('reassign/*') || Request::is('auto_dialer') || Request::is('auto_dialer/*') || Request::is('pullout') || Request::is('pullout/*') || Request::is('leads_status') || Request::is('leads_status/*') ? 'show active' : '' }}" id="kt_header_tab_2">
											...
											<div id="kt_header_menu" class="header-menu header-menu-mobile header-menu-layout-default">
												...
												<ul class="menu-nav">
													...
													<li class="menu-item {{ Request::is('leads_status') || Request::is('leads_status/*') ? 'menu-item-active' : '' }}" aria-haspopup="true">
														<a href="{{ route('pages.leads_status.index') }}" class="menu-link">
															<span class="menu-text">Bulk Update Leads Status</span>
														</a>
													</li>
										...
										<!--begin::Tab Pane-->
										<div class="tab-pane py-5 p-lg-0 {{ Request::is('sms_template') || Request::is('sms_template/*') || Request::is('users') || Request::is('users/*') || Request::is('groups') || Request::is('groups/*') || Request::is('emails') || Request::is('emails/*') || Request::is('statuses') || Request::is('statuses/*')  ? 'show active' : '' }}" id="kt_header_tab_3">
											...
											<div id="kt_header_menu" class="header-menu header-menu-mobile header-menu-layout-default">
												...
												<ul class="menu-nav">
													...
													<li class="menu-item {{ Request::is('statuses') || Request::is('statuses/*') ? 'menu-item-active' : '' }}" aria-haspopup="true">
														<a href="{{ route('pages.statuses.index') }}" class="menu-link">
										...
										<!--begin::Tab Pane-->
										<div class="tab-pane py-5 p-lg-0 {{ Request::is('email_logs') || Request::is('email_logs/*') || Request::is('sms_logs') || Request::is('sms_logs/*') || Request::is('leads_logs') || Request::is('leads_logs/*') || Request::is('system_logs') || Request::is('system_logs/*') || Request::is('call_status') || Request::is('call_status/*') || Request::is('call_logs') || Request::is('call_logs/*') || Request::is('summary_calls') || Request::is('summary_calls/*') || Request::is('report_logs') || Request::is('report_logs/*') ? 'show active' : '' }}" id="kt_header_tab_4">
											...
											<div id="kt_header_menu" class="header-menu header-menu-mobile header-menu-layout-default">
												...
												<ul class="menu-nav">
													...
													<li class="menu-item {{ Request::is('report_logs') || Request::is('report_logs/*') ? 'menu-item-active' : '' }}" aria-haspopup="true">
														<a href="{{ route('pages.reports.report_logs.index') }}" class="menu-link">
