							...
							<div class="container">
								...
								<div class="d-none d-lg-flex align-items-center mr-3">
									...
									<a href="index.html" class="mr-20">
										<img alt="Logo" src="{{ asset('media/logos/logo-letter-9.png') }}" class="max-h-35px" />
									</a>
									<!--end::Logo-->
							...
							<div class="container">
								...
								<div class="row">
									<div class="col-xl-4">
										...
										<div class="card card-custom bgi-no-repeat gutter-b card-stretch" style="background-position: right top; background-size: 30% auto; background-image: url({{ asset('media/svg/shapes/abstract-4.svg') }})">
											<!--begin::Body-->
											<div class="card-body">
									...
									<div class="col-xl-4">
										...
										<div class="card card-custom bgi-no-repeat gutter-b card-stretch" style="background-position: right top; background-size: 30% auto; background-image: url({{ asset('media/svg/shapes/abstract-2.svg') }})">
											<!--begin::Body-->
											<div class="card-body">
									...
									<div class="col-xl-4">
										...
										<div class="card card-custom bgi-no-repeat gutter-b card-stretch" style="background-position: right top; background-size: 30% auto; background-image: url({{ asset('media/svg/shapes/abstract-1.svg') }})">
											<!--begin::body-->
											<div class="card-body">
