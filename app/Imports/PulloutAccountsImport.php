...
class PulloutAccountsImport implements ToModel, WithBatchInserts, WithChunkReading, WithStartRow, WithCalculatedFormulas
{
    /**
    * @param Collection $collection
    */
    public $user_id, $uniq_id;

    public function __construct($user_id, $uniq_id)
    {
