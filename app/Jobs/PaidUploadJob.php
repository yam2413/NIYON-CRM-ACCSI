...
class PaidUploadJob implements ShouldQueue
{
     ...
     * @return void
     */
    public $file_id, $extension, $user_id;
    public function __construct($file_id, $extension, $user_id)
    {
    ...
    public function handle()
    {
        ...
        //$done = Excel::import(new TempUploadsImport($file_id, $user_id), $file_path);
