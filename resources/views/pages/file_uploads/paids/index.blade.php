...
@section('title', 'Upload Paid Accounts')
@section('content')
<!--begin::Entry-->
									...
									<div class="card-header">
										<div class="card-title">
											<span class="card-icon">
												<i class="fas fa-money-bill-wave-alt text-primary icon-3x mr-5"></i>
											</span>
...
KTUtil.ready(function() {
    ...
    $('#kt_dropzone_1').dropzone({
        url: "/upload_paids/upload_paid_file", // Set the url for your upload script location
